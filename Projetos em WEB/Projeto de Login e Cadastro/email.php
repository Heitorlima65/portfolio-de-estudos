...
function mandarEmail($nomeDestinatario,$To,$Subject,$Message) {
	...
	$mail->Username = 'aluno2d.s';         	// SMTP username
	$mail->Password = 'ehri qouv gfan nekn
';				// SMTP password
	$mail->From = 'aluno2d.s@gmail.com';
	$mail->FromName = utf8_decode('Sistema do RM 25120!');
	if (gettype($To)=="array") {
	...
	$Message.="<br><br>Equipe de contas do servidor ETEC 25120"; // Coloque seu RM aqui
